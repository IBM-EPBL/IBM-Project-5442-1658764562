...
!unzip '/content/drive/MyDrive/IBM/Fertilizers_Recommendation_ System_For_Disease_ Prediction.zip'

train_path="/content/Dataset Plant Disease/Veg-dataset/Veg-dataset/train_set"
test_path="/content/Dataset Plant Disease/Veg-dataset/Veg-dataset/test_set"
